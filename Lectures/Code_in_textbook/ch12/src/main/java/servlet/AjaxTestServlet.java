...
public class AjaxTestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		stus.put("20230101", "陈恒01,77,计算机学院");
		stus.put("20230102", "陈恒02,88,软件学院");
		stus.put("20230103", "陈恒03,99,信息学院");*/
		//定义3个学生信息对象
		Student s1 = new Student("20230101", "陈恒01",77,"计算机学院");
		Student s2 = new Student("20230102", "陈恒02",88,"软件学院");
		Student s3 = new Student("20230103", "陈恒03",99,"信息学院");
		//使用Map模拟学生信息的数据库
